...
def main():
    input_image_path = "3.jpg"  # Specify the input image path
    display_width = 800  # Adjust the display width as desired
    ...
    while True:
        ...
        # Resize the image for better GUI display
        image = resize_image(image, display_width)

        # Display the image
        cv2.imshow("Image", image)

        # Ask the user to draw a rectangle over the object
